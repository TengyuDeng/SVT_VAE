...
def collate_fn_frame_based(list_data):
    ...
    raw_features, raw_pitches, raw_onsets, raw_texts, raw_tatums = tuple(zip(*list_data))
...
def collate_fn_tatum_based(list_data):
    ...
    return (audio_features, pitches, onsets, texts, input_lengths, text_lengths, tatum_frames)
